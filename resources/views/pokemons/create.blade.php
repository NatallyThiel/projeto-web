...
<body>
    <form action="{{ url('pokemons') }}" method="POST" class="pokemon-form">
        @csrf
        <h2>Criar Pokemon</h2>
        ...
        <div class="form-group">
            ...
            <textarea name="pontos_de_poder" id="pontos_de_poder" placeholder="Pontos de poder" required></textarea>
        </div>
        <button type="submit" class="submit-btn">Criar Pokemon</button>
    </form>
</body>
</html>
